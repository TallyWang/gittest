...
public class checkwinninginfoServlet extends HttpServlet {

	private static Logger mylogger = Logger.getLogger(checkwinninginfoServlet.class
			.getName());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		// 查詢中獎資訊
		ResponseJsonObject.put("addcommandname", "winning");
//		ResponseJsonObject.put("nextfuction", "0");
//		ResponseJsonObject.put("nextstep", "0");
		ResponseJsonObject.put("varmsg", "106年03~04月電子發票號碼AB12345678中獎資訊，<br>106年03~04月電子發票號碼AB12335679中獎資訊");
