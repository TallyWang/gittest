...
public class ExcallClearServlet extends HttpServlet {
	
	private static Logger mylogger = Logger.getLogger(ExcallClearServlet.class.getName());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			...
			ResponseJsonObject.put("exception", e.getMessage());
		}
