...
public class checkpaymoneyServlet extends HttpServlet {
	
	private static Logger mylogger = Logger.getLogger(checkpaymoneyServlet.class.getName());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		if(jsonobject.getString(planName+"checkpaymoney").equals("yes")){
			ResponseJsonObject.put("addcommandname", jsonobject.getString(planName+"checkpaymoney"));
//			ResponseJsonObject.put("nextfuction", "0");
//			ResponseJsonObject.put("nextstep", "0");
			ResponseJsonObject.put("varphonenum", "0912122122");
