...
public class ganpenternameServlet extends HttpServlet {
	
	private static Logger mylogger = Logger.getLogger(ganpenternameServlet.class.getName());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String UserName =  cacheJsonObject.get("UserName").getAsString();
		//Do Service
		
//		ResponseJsonObject.put("verify", "fetnet");
