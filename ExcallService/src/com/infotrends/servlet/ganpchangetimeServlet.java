...
public class ganpchangetimeServlet extends HttpServlet {
	
	private static Logger mylogger = Logger.getLogger(ganpchangetimeServlet.class.getName());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		cacheJsonObject.addProperty("UserName", UserName);
		//Do Service
