...
public class checkphonenumServlet extends HttpServlet {
	
	private static Logger mylogger = Logger.getLogger(checkphonenumServlet.class.getName());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		mylogger.info("checkphonenumServlet - jsonobject: "+jsonobject);
		//Do Service
		
		if(jsonobject.getString(planName+"checkphonenum").equals("right")){
//			ResponseJsonObject.put("addcommandname", jsonobject.getString(planName+"checkphonenum"));
